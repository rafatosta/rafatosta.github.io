...
function NavBar() {
    return (
        <Disclosure as="nav" className="fixed top-0 center-0 min-w-full z-50">
            {({ open }) => (
                <>
                                        ...
                                        {navigation.map((item) => (
                                            <a
                                                ...
                                                className={classNames(
                                                    item.current ? 'bg-dark text-white' : 'text-dark hover:bg-dark/70 hover:text-white',
